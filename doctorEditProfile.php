...
if (isset($_POST['add_info'])) {
  ...
  if ($num1==1 && $num2==1) {
    ...
    $insertSql=" UPDATE doctors SET NAME='$name', EMAIL='$email' WHERE ID='$ID' ";
    $upSql_D_name=" UPDATE visit SET D_NAME='$name' WHERE D_NAME='$name' ";

    if ($conn-> query($insertSql) && ($conn->query($upSql_D_name))) {
...
<head>
	...
	<link rel="stylesheet" href="css/doctorEditProfile.css">
			...
			<div class="col-md-5 offset-2 mt-5 card bg-countom centered">
				...
				<form action=" <?php echo $_SERVER['PHP_SELF'];?> " method="post">
					<?php
						...
						$edit_result="SELECT * FROM doctors WHERE NAME='$currentUser'";
