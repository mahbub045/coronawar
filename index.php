  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-4 col-sm-6 col-12 text-center pre_item">
        ...
        <p>Hand washing, is remove viruse, bacteria, germs or other harmful and unwanted substances stuck to the hands.</p>
      </div>
      <!-- single item end -->
      <!-- single item start -->
      <div class="col-md-4 col-sm-6 col-12 text-center pre_item extra-padding">
        ...
        <h3>Use Mask</h3>
        <p>Most people infected with the COVID -19. Wearing of facial masks can reduce the spread of Corona Virus substantailly.</p>
      </div>
      <!-- single item end -->
      <!-- single item start -->
      <div class="col-md-4 col-sm-6 col-12 text-center pre_item">
        ...
        <p>Amid the panic over the coronavirus outbreak, it seems, people have forgotten that Sanitizer 
        is defense against disease.</p>
      </div>
      <!-- single item end -->
      <!-- single item start -->
      <div class="col-md-4 col-sm-6 col-12 text-center pre_item">
        ...
        <p>The people are changing their habits at work, home and in worship to reduce the risk of contracting the new coronavirus.</p>
      </div>
      <!-- single item end -->
      <!-- single item start -->
      <div class="col-md-4 col-sm-6 col-12 text-center pre_item">
        ...
        <h3>Avoid Touch</h3>
        <p>It’s a quirk of human nature that we touch our eyes, noses and mouths all day long. It’s also a major way we pick up infections like coronavirus.</p>
      </div>
      <!-- single item end -->
      <!-- single item start -->
      <div class="col-md-4 col-sm-6 col-12 text-center pre_item">
        ...
        <p>Most people infected with the COVID -19. If you have symptoms, call your primary care provider before coming to the hospital.</p>
      </div>
      <!-- single item end -->
    </div>
    <!-- 2nd row end -->
...
<section class="faq" id="faq">
  <div class="container">
    <div class="row">
      <!-- 1st row start -->
      <div class="offset-lg-2 col-lg-8 offset-md-3 col-md-7 text-center faq_title">
        <h2 class="custom_h2">Do you have any questions?</h2>
        <h1 class="custom_h1">Frequently Asked Questions</h1>
      </div>
      <!-- 1st row end -->
      <!-- 2nd row start -->
      <div class="row faq_content">
        <div class="col-md-5 col-12 faq_r1">
          <div class="row">
            <div class="col-md-12">
              <h3>What is a coronavirus?</h3>
              <p>Coronaviruses are a large family of viruses which may cause illness in animals or humans.  In humans, several coronaviruses are known to cause respiratory infections ranging from the common. which are expelled when a person with COVID-19 coughs.</p>
            </div>  
          </div>
          <div class="row form_row">
            <div class="col-md-12 col-12">
              <h3>Have any questions?</h3>
              <p>Send your questions in our mail</p>
              <form class="form-inline d_grid">
                <div class="form-group pt-2">
                  <label for="email" class="sr-only">email</label>
                  <input type="email" class="form-control" id="email" placeholder="Enter your email">
                </div>
                <button type="submit" class="btn btn-custom mb-2">Submit Now</button>
              </form>
            </div>
          </div>
        </div>
        <div class="offset-md-1 col-md-6 faq_r2">
          <div class="row">
            <div class="col-12">
              <h3>How does COVID-19 Grow?</h3>
          ...
          <div class="row">
            <div class="col-12">
              ...
              <p>The most common symptoms of COVID-19 are fever, dry cough, and tiredness. Some patients may have aches and pains, nasal.</p>
            </div>  
          </div>
        </div>
      </div>
